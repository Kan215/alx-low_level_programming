...
/**
 * print_data -func prints the data of an ELF header.
...
/**
 *  * print_version -func prints the version of an ELF header.
...
/**
 * print_entry -func prints the entry point of an ELF header.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	p = read(a, header, sizeof(Elf64_Ehdr));
	if (p == -1)
	{
		free(header);
		close_elf(a);
